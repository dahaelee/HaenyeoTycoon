...
public class quest_Data : MonoBehaviour
{
    ...
    public void newStart()
    {
        ...
        daily_quest_list.Add(new Daily_quest_form(-1, "전복 4개 채집하기", "오늘의 점심", 1, "해녀야 요즘 에어프라이기로 해먹는 전복버터구이가 유행이라던데.. 오늘 점심에 한번 해먹어 볼까?", "", "자원 곱배기 3개"));
        ...
        daily_quest_list.Add(new Daily_quest_form(-1, "조개 5개 채집하기", "오늘의 점심", 1, "깔끔한 국물에 매운맛이 일품인 조개탕.. 생각만 해도 군침이 싹 도는구나.. 해녀야.. 조개를 부탁하마..", "", "자원 곱배기 4개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "양식 조개 10개 채집하기", "양식의달인", 2, "옆 가게에서 조개가 집단 폐사 했다고 다시 보내달라고 하더구나 양식 조개 10마리만 부탁하마", "", "7만원"));
        daily_quest_list.Add(new Daily_quest_form(-1, "황금 오리발 구입하기", "장비 업그레이드", 2, "장비 제품 행사가 다시 돌아왔단다! 오리발 업그레이드 시 싹쓸이 그물 3개를 얻어갈 수 있으니\n좋은 기회 놓치지 마렴", "", "싹쓸이 그물 3개"));
