...
public class quest_Data : MonoBehaviour
{
    ...
    public void newStart()
    {
        ...
        daily_quest_list.Add(new Daily_quest_form(-1, "양식장 6개 확장하기", "양식의 달인", 1, "해녀야.. 이제는 정말 베테랑 해녀라고 불러도 되겠어 양식장을 늘리면 한번에 더 많은 자원을 양식할 수 있단다\n양식장을 늘려보겠니?", "", "힘찬 발장구 5개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "3번 연속 이기기", "내기의 달인", 2, "너의 가위바위보 솜씨가 예사롭지 않더구나 조금 더 자극적인 내기를 진행해볼까?\n쉽지 않을 거다 껄껄","","10만원"));
        daily_quest_list.Add(new Daily_quest_form(-1, "하루 50만원 이상 송금하기", "빚갚기의 달인", 1, "목표를 세우면 더 성실한 하루를 살 수 있단다\n이런 목표는 어떠니?", "", "체력 추가 3개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "전복 4개 채집하기", "오늘의 점심", 1, "해녀야 요즘 에어프라이기로 해먹는 전복버터구이가 유행이라던데.. 오늘 점심에 한번 해먹어 볼까?", "", "자원 곱배기 5개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "양식 꽃게 5번 수확하기", "양식의 달인", 2, "해녀야 가게 한편에 간장게장과 양념게장 반찬을 판매하려 하는데 어떨 것 같니? 아저씨가 손 맛이 생각보다 좋단다 허허", "", "15만원"));
        daily_quest_list.Add(new Daily_quest_form(-1, "조금 비싼 물안경 구입하기", "장비 업그레이드", 2, "오늘부터 물안경 제품 행사가 시작된단다! 물안경 업그레이드 시 싹쓸이 그물 3개를 얻어갈 수 있으니 좋은 기회 놓치지 마렴", "", "싹쓸이 그물 5개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "조개 5개 채집하기", "오늘의 점심", 1, "깔끔한 국물에 매운맛이 일품인 조개탕.. 생각만 해도 군침이 싹 도는구나.. 해녀야.. 조개를 부탁하마..", "", "자원 곱배기 5개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "양식 조개 10개 채집하기", "양식의달인", 2, "옆 가게에서 조개가 집단 폐사 했다고 다시 보내달라고 하더구나 양식 조개 10마리만 부탁하마", "", "10만원"));
        daily_quest_list.Add(new Daily_quest_form(-1, "황금 오리발 구입하기", "장비 업그레이드", 2, "장비 제품 행사가 다시 돌아왔단다! 오리발 업그레이드 시 싹쓸이 그물 3개를 얻어갈 수 있으니\n좋은 기회 놓치지 마렴", "", "싹쓸이 그물 5개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "거북이 3개 채집하기", "깊은 바닷속 자원", 1, "해녀야 깊은 바다에서 거북이를 본 적이 있니? 아니 옆집 아저씨가 아무리 설명해도 믿질 않더구나! 거북이 3마리만 부탁하마", "", "체력 추가 3개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "양식 전복 5번 수확하기", "양식의 달인", 2, "요즘 전복 수요가 높아졌어. 훌륭한 상점 주인이 되려면 흐름을 읽을 줄 알아야 한단다 허허. 전복을 준비해놔야 겠구나", "", "10만원"));
        daily_quest_list.Add(new Daily_quest_form(-1, "하루 80만원 이상 송금하기", "빚갚기의 달인", 1, "목표를 세우면 더 성실한 하루를 살 수 있단다\n이런 목표는 어떠니?", "", "힘찬 발장구 5개"));
        ...
        daily_quest_list.Add(new Daily_quest_form(-1, "바다에서 금화 3개 모으기", "바다에서 돈모으기", 1, "해녀야 너의 사주에 금이 부족해.. 항상 몸에 금을 소지하고 있으려구나.. ", "", "체력 추가 5개"));
        daily_quest_list.Add(new Daily_quest_form(-1, "꽃게 5개 채집하기", "제철 해산물", 2, "과일도 제철 과일이 맛있고,\n해산물도 제철 해산물이 맛있지.\n그런고로, 오늘은 꽃게를 가져오면 짭짤하게 쳐주마!", "", "10만원"));
        daily_quest_list.Add(new Daily_quest_form(-1, "양식 꽃게 3번 수확하기", "양식의 달인", 2, "긴급긴급!! 오늘 자전거 동호회가 온다더구나! 꽃게찜을 예약해 놨는데 빨리 가져다 줄 수 있겠니?", "", "7만원"));
        daily_quest_list.Add(new Daily_quest_form(-1, "양식 전복 3번 수확하기", "양식의 달인", 1, "해녀야.. 요새 통 전복이 먹고 싶더구나 전복을 구해다 줄 수 있겠니?", "", "10만원"));
        daily_quest_list.Add(new Daily_quest_form(-1, "모든 자원 하나씩 잡기", "마지막 퀘스트", 1, "해녀야.. 벌써 내일이면 30일이 되는 구나.. 마지막으로 바다에 있는 모든 자원을 잡아와 볼래?", "", "30만원"));
